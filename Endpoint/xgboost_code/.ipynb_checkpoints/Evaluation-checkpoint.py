...
def model_fn(model_dir):
    ...
    model = XGBClassifier()
    model.load_model("/opt/ml/model/model.json")
    return model
...
#         f.write(json.dumps(report_dict))
    ...
    prediction_dataframe.to_csv(f"{output_dir}/Prediction.csv", index = False)
    
    return json.loads(prediction_dataframe.to_json()) 
    # return report_dict
